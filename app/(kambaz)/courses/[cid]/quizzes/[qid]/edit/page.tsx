    ...
    <>
      <div className="d-flex align-items-center justify-content-end mt-3 mb-3">
        ...
        <div className="me-1 align-items-center d-flex">
          {quizState.published ? ( <GreenCheckmark />) :
      ...
      <Form>
        ...
        <FormGroup controlId="quiz-type">
          <Row>
            <FormLabel column sm={{span: 1, offset: 3}} className="text-end mb-4">Quiz Type</FormLabel> 
              <Col sm={8}> 
            ...
            <FormLabel column sm={{span: 2, offset: 2}} className="text-end mb-4"></FormLabel> 
              <Col sm={8}> 
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <FormControl disabled={isStudent} className="me-2 ms-5" style={{ width: "110px" }}
        ...
        <FormGroup className="mb-4">
          <Row>
            ...
            <Col sm={8} className="border rounded p-3">
              <FormCheck disabled={isStudent} defaultChecked={quizState.multipleAttempts === "Yes"} type="checkbox" label="Allow Multiple Attempts" className="me-3"/>
            </Col>
          </Row>
        </FormGroup>
        ...
        <Row>
          ...
          <Col sm={8} className="border p-3">
            <Row>
              <Col>
                <FormLabel htmlFor="quiz-assign-to" column className="mb-1 fw-bold">Assign To</FormLabel>
              </Col>
            </Row>
            <Row>
              <Col className="mb-3"> 
            ...
            <Row>
              ...
              <InputGroup className="mb-3" > 
                <FormControl disabled={isStudent} id="wd-due-date" value={quizState.due}
                  onChange={(e) => setQuizState({...quizState, due: e.target.value})} /> 
                <InputGroupText>
                  <FaRegCalendarAlt />
                </InputGroupText> 
              </InputGroup>
            ...
            <Row>
              <Col>
                ...
                <InputGroup className="mb-3" > 
                    <FormControl disabled={isStudent} id="wd-available-from" value={quizState.available}
                      onChange={(e) => setQuizState({...quizState, available: e.target.value})} /> 
                    <InputGroupText>
                      <FaRegCalendarAlt />
                    </InputGroupText> 
                </InputGroup>
              ...
              <Col>
                ...
                <InputGroup className="mb-3" > 
                    <FormControl disabled={isStudent} id="wd-available-until" value={quizState.until}
                      onChange={(e) => setQuizState({...quizState, until: e.target.value})} /> 
                    <InputGroupText>
                      <FaRegCalendarAlt />
                    </InputGroupText> 
                  </InputGroup>
      ...
      <FormGroup controlId="show-correct-answers">
          <Row>
            <FormLabel column sm={{span: 2, offset: 2}} className="text-end mb-4">Show Correct Answers</FormLabel> 
              <Col sm={8}> 
